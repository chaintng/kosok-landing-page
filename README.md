...
Named exports are useful for utility modules that export several functions. A namespace may have at most one default export and as many named exports as you like.
...
However there is an **escape hatch** that you can use to add an asset outside of the namespace system.
...
**The step below is important!** as br
...
src as img="http://i.imgur.com/HUjEr9l.png" width="500" alt="gh-pages branch setting">
...
To add a specific Moment.js locale to your bundle, you need to import it explicitly.For as br example:
